...
ALTER TABLE email_login_codes ADD COLUMN IF NOT EXISTS purpose TEXT NOT NULL DEFAULT 'register';
ALTER TABLE email_login_codes ADD COLUMN IF NOT EXISTS attempt_count INTEGER NOT NULL DEFAULT 0;
