...
export const EmailRegisterRequestSchema = EmailLoginRequestSchema;

export const EmailRegisterVerifyRequestSchema = EmailVerifyRequestSchema.extend({
	password: z
		.string()
...
export const EmailPasswordLoginRequestSchema = EmailLoginRequestSchema.extend({
	password: z
		.string()
		.min(8, "Password must be at least 8 characters")
		.max(128, "Password must be at most 128 characters"),
