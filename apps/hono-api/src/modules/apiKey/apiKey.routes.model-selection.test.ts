...
function makeCtx(): AppContext {
	return {
		env: {
			DB: {},
			NEW_API_INTERNAL_BASE_URL: "https://new-api.example.com",
			NEW_API_INTERNAL_TOKEN: "new-api-test-token",
...
describe("buildPublicVisionTaskRequest", () => {
	...
	it("uses the default modelKey only when both modelAlias and modelKey are absent", () => {
		const request = buildPublicVisionTaskRequest(
			{
				imageUrl: "https://example.com/reference.png",
			},
