...
export default function ExecutionPanel(props: {
  ...
  const panelTop = calculateSafePanelTop(anchorY, 190)

  return (
    <div className="execution-panel-anchor" style={{ position: 'fixed', left: 82, top: panelTop, zIndex: 200 }} data-ux-panel>
