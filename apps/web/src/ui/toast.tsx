...
import { calculateHeaderSafeTop } from './utils/panelPosition'
...
export function ToastHost({ className }: { className?: string }): JSX.Element {
  ...
  return (
    <BodyPortal>
      <div className={hostClassName} style={{ position: 'fixed', top: calculateHeaderSafeTop(16), right: 16, display: 'flex', flexDirection: 'column', gap: 8, zIndex: UI_LAYERS.notification }}>
        {items.map(i => (
