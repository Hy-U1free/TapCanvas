...
import { calculateSafeMaxHeight, calculateSafePanelTop } from './utils/panelPosition'
...
export default function ProjectPanel(): JSX.Element | null {
  ...
  const panelTop = calculateSafePanelTop(anchorY, 150)

  return (
    <div className="project-panel-anchor" style={{ position: 'fixed', left: 82, top: panelTop, zIndex: 300 }} data-ux-panel>
                            ...
                            <Group className="project-panel-card-actions" gap={6} align="center">
                              ...
                              >
                                <Popover
                                  ...
                                  radius="md"
                                  withinPortal
                                  dropdownProps={{ withinPortal: true, zIndex: UI_LAYERS.floatingPopover }}
                                  closeOnClickOutside
                                >
