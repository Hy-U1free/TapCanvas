...
export default function ModelPanel(): JSX.Element | null {
  ...
  const panelTop = calculateSafePanelTop(anchorY, 160)
  const apiKeyHint = 'API Key（保存到本地 localStorage）'

  return (
    <div className="tc-model-panel-anchor" style={{ position: 'fixed', left: 82, top: panelTop, zIndex: 200 }} data-ux-panel>
