...
export default function AccountPanel(): JSX.Element | null {
  ...
  const maxHeight = calculateSafeMaxHeight(anchorY, 100)
  const panelTop = calculateSafePanelTop(anchorY, 100)
  const accountTypeLabel = team?.id?.startsWith('personal_') ? '个人' : '企业'
  return (
    <div className="account-panel-anchor" style={{ position: 'fixed', left: 82, top: panelTop, zIndex: 200 }} data-ux-panel>
