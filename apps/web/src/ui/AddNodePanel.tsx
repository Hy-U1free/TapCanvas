...
export default function AddNodePanel({ className }: { className?: string }): JSX.Element | null {
  ...
  const panelTop = calculateSafePanelTop(anchorY, 120, 64)
  const maxHeight = calculateSafeMaxHeight(anchorY, 120, 40, 64)
  ...
  return (
    <div className={panelClassName} style={{ position: 'fixed', left: 82, top: panelTop, zIndex: 200 }} data-ux-panel>
